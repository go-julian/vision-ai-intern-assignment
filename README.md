...
This is the instruction for AI intern assignment at [Golden Owl](https://goldenowl.asia). You will build a simple Image Classification model base on [Teachable Machine](https://teachablemachine.withgoogle.com/) or [Tensorflow](https://tensorflow.org/) or Pytorch.
